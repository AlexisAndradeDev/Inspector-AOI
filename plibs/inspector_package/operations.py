...
class ObjectInspected:
    ...
    def set_board_results(self, registration_time, inspection_time, stage):
        """
        El parÃ¡metro << stage >> se refiere a la etapa en la que se estÃ¡: debugeo o inspecciÃ³n.
        Si se estÃ¡ en debugeo, el tiempo de registro no se escribe ya que no se registra el tablero en debugeo.
        Si se estÃ¡ en inspecciÃ³n, se escribe el tiempo de registro e inspecciÃ³n.
        """
        if stage == "inspection":
